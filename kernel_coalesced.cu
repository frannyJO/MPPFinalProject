...
__global__ void pvSolveKernelCoalesced(int num_panels, int newton_iters,
...
void solvePVPlantCoalesced(int num_panels, int newton_iters,
    ...
    double *total_power_d)
{
    ...
    pvSolveKernelCoalesced<<<dim_grid, dim_block>>>(num_panels, newton_iters,
